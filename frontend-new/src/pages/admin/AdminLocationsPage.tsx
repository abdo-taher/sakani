...
export const AdminLocationsPage: React.FC = () => {
    ...
    try {
      ...
      if (Array.isArray(res) && res.length > 0) {
        const mapped: LocationDistrict[] = res.map((loc: any) => ({
          ...
          image_url: loc.image_url || loc.image || 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?auto=format&fit=crop&w=800&q=80',
  ...
  const handleSaveDistrict = async (e: React.FormEvent) => {
    ...
    setIsSaving(true);
    const finalImage = districtImage.trim() || 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?auto=format&fit=crop&w=800&q=80';
            ...
            >
              ...
              <div className="relative aspect-[16/10] bg-slate-100 overflow-hidden">
                <img 
                  ...
                  onError={(e) => {
                    (e.target as HTMLElement).setAttribute('src', 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?auto=format&fit=crop&w=800&q=80');
                  }}
                />
