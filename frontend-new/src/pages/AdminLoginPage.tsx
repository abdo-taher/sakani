      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl p-6 sm:p-8 space-y-6 relative border border-slate-100 z-10 animate-fade-in">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-500">
            لوحة الإدارة والتحكم الشاملة في عقارات وحجوزات دمياط الجديدة
          </p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="p-3 bg-amber-50 rounded-xl border border-amber-200/80 text-[11px] text-[#8D6A28] font-medium flex items-center gap-2">
            <ShieldCheck className="w-4 h-4 shrink-0" />
            <span>بيانات الدخول التجريبية مجهزة افتراضياً (admin / sakani2026)</span>
          </div>

          <button
            type="submit"
            disabled={loading}
            className="w-full py-3.5 rounded-xl gold-gradient gold-gradient-hover text-white font-black text-sm shadow-md hover:shadow-lg transition flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
          >
