...
export const NeedRequestModal: React.FC<NeedRequestModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-950/75 flex justify-center items-center p-4 transition-opacity duration-150" dir="rtl">
      
      <div 
        className="relative bg-white w-full max-w-lg rounded-3xl shadow-2xl overflow-hidden modal-animate-pop my-auto"
