...
export const AddPropertyModal: React.FC<AddPropertyModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-950/75 flex justify-center items-center p-3 sm:p-6 transition-opacity duration-150" dir="rtl">
      
      <div 
        className="relative bg-white w-full max-w-2xl rounded-3xl shadow-2xl overflow-hidden modal-animate-pop my-auto max-h-[92vh] flex flex-col"
