...
export const InquiryModal: React.FC<InquiryModalProps> = ({
  ...
  // Lock body scroll and reset state when opening modal
  useEffect(() => {
    if (!isOpen) return;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    safeDispatchEvent('sakani_reservation_created', {
  ...
  return createPortal(
    ...
    >
      <div 
        className="relative bg-white w-full max-w-md rounded-3xl shadow-2xl overflow-hidden modal-animate-pop my-auto max-h-[92vh] flex flex-col"
