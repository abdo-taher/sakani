...
export const DEFAULT_SITE_TITLE = 'سكني | عقارات وشقق للبيع والإيجار في دمياط الجديدة';
export const DEFAULT_SITE_DESCRIPTION = 'منصة سكني العقارية الرائدة للبيع والشراء والإيجار وحجز الغرف في دمياط الجديدة والمناطق المميزة مع معاينات فورية وتجربة ذكية.';
